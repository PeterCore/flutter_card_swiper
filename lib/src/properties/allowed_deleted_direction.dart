...
class AllowedDeleteDirection {
  /// Allow the card to be swiped in any direction
  const AllowedDeleteDirection.all()
      : up = true,
        down = true,
        right = true,
        left = true;
  ...
  const AllowedDeleteDirection.none()
      : up = false,
        down = false,
        right = false,
        left = false;
  ...
  const AllowedDeleteDirection.only({
    this.up = false,
    this.down = false,
    this.left = false,
    this.right = false,
  ...
  const AllowedDeleteDirection.symmetric({
